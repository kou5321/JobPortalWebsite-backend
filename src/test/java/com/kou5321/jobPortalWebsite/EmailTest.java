...
public class EmailTest {
    public static void main(String[] args) {
        final String username = "kouyixiao86@gmail.com"; // replace with your email
        final String password = "bkiirxdggcparffh"; // replace with your password or app-specific password
        ...
        try {
            ...
            message.setFrom(new InternetAddress("kouyixiao86@gmail.com")); // replace with your email
